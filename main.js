var pgData = {
    ...
    "cv_particles": {
        ...
        tags: ["interactive","camera","lines","cv"],
        mobile: false,
        description: "A particle system you can interact with using your camera! Uses OpenCV.js to compute optical flow in real time in the browser. USE CHROME ONLY!!"
    }
}
